...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--project-dir",
        default="projects/2026-05-fujie-gcard-v1",
...
def write_markdown(path: Path, payload: dict, summary_rows: list[dict], sample_columns: list[dict]) -> None:
    lines = [
        "# 复借G卡特征表清单",
        "",
...
def main() -> int:
    ...
    output_dir = project_dir / "data/profile/feature_metadata"
    docs_path = project_dir / "docs/特征表清单.md"
    ...
    sample_column_names = {col["name"] for col in sample_columns} | BASE_SAMPLE_COLUMNS
    ...
    write_markdown(docs_path, all_meta, summary_rows, sample_columns)
